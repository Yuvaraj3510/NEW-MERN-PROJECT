...
const seedUsers = [
  {
    ...
    name: 'Aarav Sharma',
    email: 'admin@districtpulse.in',
    password: '$2a$10$YourHashedPasswordHerePlaceholder',
    rawPassword: 'admin123',
    role: 'admin',
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=400&q=80',
    districtPreference: 'Bengaluru Tech & Silicon Corridor',
    wishlist: ['6620a2222222222222222201', '6620a2222222222222222205'],
  },
  {
    _id: '6610a1111111111111111102',
    name: 'Rohan Verma',
    email: 'user@districtpulse.in',
    password: '$2a$10$YourHashedPasswordHerePlaceholder',
    rawPassword: 'user123',
    role: 'user',
    avatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=400&q=80',
    districtPreference: 'Mumbai Marine Drive & South Bombay',
    wishlist: ['6620a2222222222222222201', '6620a2222222222222222202', '6620a2222222222222222208'],
  },
  {
    _id: '6610a1111111111111111103',
    name: 'Priya Nambiar',
    email: 'priya@steppinoutindia.com',
    password: '$2a$10$YourHashedPasswordHerePlaceholder',
    rawPassword: 'priya123',
    role: 'organizer',
    avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=400&q=80',
    districtPreference: 'Goa Coastal & Beachside District',
    wishlist: ['6620a2222222222222222211'],
  },
  {
    _id: '6610a1111111111111111104',
    name: 'Ananya Iyer',
    email: 'ananya@districtpulse.in',
    password: '$2a$10$YourHashedPasswordHerePlaceholder',
    rawPassword: 'ananya123',
    role: 'user',
    avatar: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=400&q=80',
    districtPreference: 'Chennai Coastal & Music Quarter',
    wishlist: ['6620a2222222222222222222'],
  },
  {
    _id: '6610a1111111111111111105',
    name: 'Vikram Malhotra',
    email: 'vikram@districtpulse.in',
    password: '$2a$10$YourHashedPasswordHerePlaceholder',
    rawPassword: 'vikram123',
    role: 'user',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80',
    districtPreference: 'Delhi NCR & Heritage Cultural Quarter',
    wishlist: ['6620a2222222222222222208'],
  }
];
...
const seedBookings = [
  {
    _id: '6630a3333333333333333301',
    bookingReference: 'DP-2026-IND-88941',
    user: '6610a1111111111111111102',
    event: '6620a2222222222222222205',
    tierName: 'Gold Fan Zone Pit',
    tierPrice: 3499,
    quantity: 2,
    subtotal: 6998,
    serviceFee: 350,
    ...
    qrCodeDataUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="160" height="160"><rect width="160" height="160" fill="%230b0f19"/><text x="50%" y="50%" fill="%236366f1" dominant-baseline="middle" text-anchor="middle" font-size="11">OFFICIAL PASS: DP-2026-IND-88941</text></svg>',
    paymentStatus: 'paid',
    bookingStatus: 'confirmed',
    createdAt: new Date(Date.now() - 86400000 * 2),
  },
  {
    _id: '6630a3333333333333333302',
    bookingReference: 'DP-2026-IND-99312',
    user: '6610a1111111111111111102',
    event: '6620a2222222222222222201',
    tierName: 'VIP Sky Deck Lounge',
    tierPrice: 2999,
    quantity: 1,
    subtotal: 2999,
    serviceFee: 150,
    ...
    qrCodeDataUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="160" height="160"><rect width="160" height="160" fill="%230b0f19"/><text x="50%" y="50%" fill="%2310b981" dominant-baseline="middle" text-anchor="middle" font-size="11">OFFICIAL PASS: DP-2026-IND-99312</text></svg>',
    paymentStatus: 'paid',
    bookingStatus: 'confirmed',
    createdAt: new Date(Date.now() - 86400000 * 5),
  },
  {
    _id: '6630a3333333333333333303',
    bookingReference: 'DP-2026-IND-44120',
    user: '6610a1111111111111111104',
    event: '6620a2222222222222222222',
    tierName: 'Grand Auditorium Orchestra Row',
    tierPrice: 1499,
    quantity: 2,
    subtotal: 2998,
    serviceFee: 150,
    ...
    qrCodeDataUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="160" height="160"><rect width="160" height="160" fill="%230b0f19"/><text x="50%" y="50%" fill="%23ec4899" dominant-baseline="middle" text-anchor="middle" font-size="11">OFFICIAL PASS: DP-2026-IND-44120</text></svg>',
    paymentStatus: 'paid',
    bookingStatus: 'confirmed',
...
async function initializeMemoryStore() {
  ...
  global.__IN_MEMORY_DB__ = {
    users: usersWithHashedPw,
    events: JSON.parse(JSON.stringify(seedEvents)),
    bookings: JSON.parse(JSON.stringify(seedBookings)),
  };

  console.log(`[DistrictPulse India] Initialized with ${seedEvents.length} events across India's top Metro Districts.`);
}
...
async function seedMongoDB() {
  try {
    ...
    console.log(`[DistrictPulse India] Seeded MongoDB Database successfully with Indian events, venues, and users!`);
  } catch (error) {
    console.warn('[DistrictPulse Seed Warning] MongoDB direct seed skipped:', error.message);
  }
}
